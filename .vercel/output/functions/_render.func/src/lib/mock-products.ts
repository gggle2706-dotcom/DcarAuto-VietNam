export interface MockProduct {
  ...
  isUniversal: boolean;
  isFeatured: boolean;
  compatibleBrands: string[]; // Các hãng xe tương thích
  compatibleModels: string[]; // Các dòng xe tương thích
  description: string;
}
...
export const MOCK_PRODUCTS: MockProduct[] = [
  {
    ...
    specs: ['RAM 3GB - ROM 32GB', 'Chip 8 Nhân 2.0GHz', 'Màn IPS 2K', 'Tặng Sim 4G 1 năm'],
    warrantyMonths: 24,
    isUniversal: false,
    isFeatured: true,
    compatibleBrands: ['toyota', 'honda', 'hyundai', 'kia', 'mazda', 'mitsubishi', 'ford'],
    compatibleModels: ['vios', 'camry', 'city', 'accent', 'seltos', 'cx-5', 'xpander'],
  ...
  },
  {
    ...
    specs: ['Mắt Cam Sony A225', 'Mô phỏng 3D 28 góc nhìn', 'Ghi hình 4 hướng', 'Đánh lái theo vô lăng'],
    warrantyMonths: 24,
    isUniversal: false,
    isFeatured: true,
    compatibleBrands: ['toyota', 'honda', 'hyundai', 'kia', 'mazda', 'vinfast'],
    compatibleModels: ['vios', 'camry', 'corolla-cross', 'tucson', 'santafe', 'carnival', 'vf-8'],
  ...
  },
  {
    ...
    specs: ['Công suất Cos 60W / Pha 70W', 'Nhiệt màu 5500K bám đường', 'Chip LED 6+3 Osram', 'Bảo hành 36 tháng'],
    warrantyMonths: 36,
    isUniversal: true,
    isFeatured: true,
    compatibleBrands: [],
  ...
  },
  {
    ...
    specs: ['Công suất RMS 200W / Max 450W', 'Âm bass sâu và chắc', 'Kích thước mỏng 10 inch', 'Chính hãng Thụy Điển'],
    warrantyMonths: 24,
    isUniversal: true,
    isFeatured: true,
    compatibleBrands: [],
  ...
  },
  {
    ...
    specs: ['RAM 8GB - ROM 128GB', 'Chip Snapdragon 6125', 'Dẫn đường Vietmap Live bản quyền', 'Cắm cổng USB / Type-C'],
    warrantyMonths: 24,
    isUniversal: true,
    isFeatured: true,
    compatibleBrands: [],
  ...
  },
  {
    ...
    specs: ['18 - 22 chi tiết đèn LED', 'Đổi màu qua App điện thoại', 'Cảm biến nháy theo nhạc', 'Dây quang cao cấp không lộ viền'],
    warrantyMonths: 12,
    isUniversal: true,
    isFeatured: false,
    compatibleBrands: [],
  ...
  },
  {
    ...
    specs: ['4 van cảm biến gắn trong', 'Pin Nhật tuổi thọ 5 năm', 'Cảnh báo giọng nói tiếng Việt', 'Đồng bộ màn hình Android'],
    warrantyMonths: 36,
    isUniversal: true,
    isFeatured: false,
    compatibleBrands: [],
  ...
  },
  {
    ...
    specs: ['Ghi hình Super HD 2K', 'Cảnh báo biển báo tốc độ bằng giọng nói', 'Cảm biến Sony Starvis', 'Kết nối Wi-Fi 5GHz tải video siêu nhanh'],
    warrantyMonths: 12,
    isUniversal: true,
    isFeatured: true,
    compatibleBrands: [],
