...
//#region src/pages/api/admin-save.ts
var admin_save_exports = /* @__PURE__ */ __exportAll({
	GET: () => GET,
	POST: () => POST,
	prerender: () => false
});
var GET = async () => {
	return new Response(JSON.stringify({ status: "admin-save-ready" }), { headers: { "Content-Type": "application/json" } });
};
...
//#endregion
//#region \0virtual:astro:page:src/pages/api/admin-save@_@ts
var page = () => admin_save_exports;
//#endregion
export { page };
