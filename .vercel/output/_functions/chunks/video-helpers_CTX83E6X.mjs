...
//#endregion
//#region src/lib/video-helpers.ts
function parseVideoUrl(url) {
	...
	const ttMatch = trimmed.match(/tiktok\.com\/(?:@[\w.-]+\/video\/|v\/|embed\/v2\/)(\d+)/);
	...
	} else if (trimmed.includes("tiktok.com") || trimmed.includes("vt.tiktok.com")) return {
		platform: "tiktok",
		videoId: null,
		embedUrl: null,
		originalUrl: trimmed,
	...
	if (trimmed.includes("facebook.com") || trimmed.includes("fb.watch")) return {
		platform: "facebook",
		videoId: null,
		embedUrl: `https://www.facebook.com/plugins/video.php?href=${encodeURIComponent(trimmed)}&show_text=false&width=auto`,
		originalUrl: trimmed,
...
//#endregion
export { MOCK_POSTS as n, parseVideoUrl as t };
